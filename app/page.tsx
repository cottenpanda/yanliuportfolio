    ...
    <div className="relative" style={{ overflowX: "clip" }} onClick={handlePageClick}>
      ...
      style={{ willChange: "transform", animation: "hero-fade-in 0.7s cubic-bezier(0.4,0,0.2,1) 3.4s both" }}>
        ...
        <div className="absolute top-[42%] left-[calc(50%+30px)] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-10">
          ...
          <p className="font-[family-name:var(--font-noto)] text-xs md:text-base text-stone-500 text-center tracking-[0.2em] uppercase hero-entrance" style={{ lineHeight: "1.8", animation: "hero-fade-in 0.5s cubic-bezier(0.4,0,0.2,1) 1.9s both" }}>
            I think, then I make
          </p>
        </div>
      </div>
      ...
      >
        <motion.a variants={{ hidden: { opacity: 0, y: 16 }, visible: { opacity: 1, y: 0 } }} transition={{ duration: 0.4 }} href="https://x.com/yanliudesign" target="_blank" rel="noopener noreferrer" className="font-[family-name:var(--font-noto)] text-[14px] text-stone-500 hover:text-stone-800 transition-colors">{`{X}`}</motion.a>
        <motion.a variants={{ hidden: { opacity: 0, y: 16 }, visible: { opacity: 1, y: 0 } }} transition={{ duration: 0.4 }} href="https://www.linkedin.com/in/uwyanliudesign" target="_blank" rel="noopener noreferrer" className="font-[family-name:var(--font-noto)] text-[14px] text-stone-500 hover:text-stone-800 transition-colors">{`{LinkedIn}`}</motion.a>
        <motion.a variants={{ hidden: { opacity: 0, y: 16 }, visible: { opacity: 1, y: 0 } }} transition={{ duration: 0.4 }} href="https://www.figma.com/@yanliu" target="_blank" rel="noopener noreferrer" className="font-[family-name:var(--font-noto)] text-[14px] text-stone-500 hover:text-stone-800 transition-colors">{`{Figma}`}</motion.a>
        <motion.a variants={{ hidden: { opacity: 0, y: 16 }, visible: { opacity: 1, y: 0 } }} transition={{ duration: 0.4 }} href="https://github.com/cottenpanda" target="_blank" rel="noopener noreferrer" className="font-[family-name:var(--font-noto)] text-[14px] text-stone-500 hover:text-stone-800 transition-colors">{`{Github}`}</motion.a>
        <motion.a variants={{ hidden: { opacity: 0, y: 16 }, visible: { opacity: 1, y: 0 } }} transition={{ duration: 0.4 }} href="https://unsplash.com/@yl1980s" target="_blank" rel="noopener noreferrer" className="font-[family-name:var(--font-noto)] text-[14px] text-stone-500 hover:text-stone-800 transition-colors">{`{Unsplash}`}</motion.a>
      </motion.div>
